...
router.post("/create", ...admin, writeLimit, categoryUpload.single("image"), createCategory);
router.put("/update/:id", ...admin, writeLimit, categoryUpload.single("image"), updateCategory);
